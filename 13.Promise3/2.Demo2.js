function fetchData(url) {
    return new Promise(function exec(resolve, reject) {
        ...
        setTimeout(function processDownloading() {
            let data = "Dummy data";
            resolve(data);
            console.log("Download completed"); // changes from prev code.
        }, 7000);
    });
}
...
/**
 ...
 -> Is there anything in call stack : yes -> processDownloading() is still in callstack.
 -> Is anything left in processDownloading() fun : yes.
